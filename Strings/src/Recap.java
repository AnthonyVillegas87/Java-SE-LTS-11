public class Recap {
    ...
    public static void EqualLiteralReferences() {
        // String literals automatically interned so all "hello" literals point to the same reference in memory, in th string pool
    ...
    public static void StringConstructors() {
        ...
        // Now evaluates to false, strings do not point to the same reference, and are not stored in the string pool
        System.out.println("s1 and s2 are string literals " + "assigned to String variables: (s1 == s2) = " + ((s1 == s2) ? "true" : false));
    }
    ...
    public static void StringConstructorsInterned() {
        ...
        // **** Add intern() method: s2 also gets the string pool reference for "hello"
