...
public class TestStatic {
    ...
    public static void main(String[] args) {
        // APP_NAME in line below can be referenced without class name because of import static statement
        System.out.println("APP_NAME = " + APP_NAME);


        //log method in line below can be referenced without class name because of import static statement
        ...
        //We instantiate StaticImportTest2() and execute method on it
